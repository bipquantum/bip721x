    ...
    return notifications.map((notification) => {
      ...
      if ("IP_PURCHASED" in notification.notificationType) {
        ...
        return {
          ...
          title: "IP Sold!",
          message: `Your IP #${data.ipId} was purchased for ${Number(data.price) / 100000000} BQC`,
          timestamp,
          isRead,
          data: {
        ...
        return {
          ...
          message: `You received ${Number(data.amount) / 100000000} BQC royalty from IP #${data.ipId}`,
          timestamp,
          isRead,
          data: {
            ipId: data.ipId.toString(),
