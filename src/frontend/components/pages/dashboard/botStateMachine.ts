...
const BIPQuantumUrl =
  import.meta.env.VITE_DFX_NETWORK == "local"
    ? "http://localhost:3000"
    : `https://${import.meta.env.VITE_CANISTER_ID_FRONTEND}.icp0.io`;
      ...
      selectCertificate: {
        on: {
          "bIP certificate": {
            ...
            actions: assign({
              intPropId: (_, event: BIPCertificateEvent | undefined) =>
                event?.intPropId,
            }),
          },
