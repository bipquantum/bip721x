                ...
                <div className="flex w-full flex-col gap-8 text-base">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Select
                      ...
                      classNames={{
                        menuButton: () =>
                          "rounded-2xl border-none bg-tertiary flex items-center justify-between px-2",
                        menu: "border-none bg-tertiary flex items-center justify-between absolute z-10 mx-4 py-2",
                      }}
                    />
                  </div>
                  <div className="flex flex-col gap-1">
