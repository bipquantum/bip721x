...
const SideBar = () => {
  ...
  return (
    <div
      className={`hidden min-h-full w-64 overflow-auto bg-primary text-white transition-all duration-200 ${pathname.includes("/bip") || pathname === "/about" ? "sm:hidden" : "sm:block"}`}
    >
